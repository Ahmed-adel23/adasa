    ...
    <section className="py-20 bg-[#111111] border-y border-[#262626]">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-4 gap-6">
          {values.map((val, idx) => (
            <div key={idx} className="group p-6 bg-[#161616] rounded-2xl border border-[#262626] hover:border-orange-500/30 transition-all text-center relative overflow-hidden">
