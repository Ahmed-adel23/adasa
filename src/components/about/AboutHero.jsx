    ...
    <section className="relative py-24 overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-4 text-center">
        <motion.span
          ...
          className="inline-flex items-center gap-2 mb-6 px-4 py-2 rounded-full bg-[#1a1a1a] border border-[#262626] text-orange-500 text-sm"
        >
        ...
        >
          مهمتنا هي{" "}
          <span className="bg-gradient-to-l from-orange-500 to-yellow-500 bg-clip-text text-transparent">
            الإعلام والإلهام
          </span>
        </motion.h1>
        <motion.p
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
          {stats.map((item, idx) => (
            <motion.div
              ...
              whileHover={{ y: -4 }}
              className="p-6 bg-[#111111]/80 backdrop-blur-sm rounded-2xl border border-[#262626] hover:border-orange-500/30 transition-all duration-300"
            >
