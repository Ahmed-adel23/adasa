      ...
      <nav className="space-y-2">
        {sections.map((section, i) => (
          <a
            key={i}
            href={`#section-${i}`}
            className="flex items-center gap-3 p-3 bg-gradient-to-r from-orange-500/10 to-yellow-500/5 rounded-2xl border border-orange-500/20 hover:from-orange-500/25 hover:to-yellow-500/25 text-white transition-all duration-300"
          >
