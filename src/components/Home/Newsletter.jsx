  ...
  return (
    <section className="py-24 relative overflow-hidden bg-[#0a0a0a]" dir="rtl">
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-[#161616] rounded-3xl border border-[#262626] p-8 md:p-12 lg:p-16 text-center shadow-2xl">
          ...
          {!isSubscribed ? (
            ...
            <div className="bg-orange-500/10 border border-orange-500/20 text-orange-500 p-4 rounded-xl mb-6 animate-pulse">
