  ...
  return (
    ...
    >
      <Link className={`flex ${isList ? "flex-col md:flex-row" : "flex-col"}`} to={`/blog/${post.slug}`}>
        <div className={`relative flex-shrink-0 overflow-hidden ${isList ? "w-full md:w-72 lg:w-80 h-52 md:h-auto" : "h-52"}`}>
          <img
            alt={post.title}
        ...
        <div className="flex-1 p-6 flex flex-col justify-center">
          ...
          <p className="text-neutral-400 mb-4 line-clamp-2 leading-relaxed text-sm">
            {post.excerpt}
          </p>
