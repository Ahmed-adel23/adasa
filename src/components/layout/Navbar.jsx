        ...
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }}>
              <Link
                to="/blog"
                className="bg-orange-600 hover:bg-orange-700 text-white px-6 py-2.5 rounded-xl text-sm font-medium transition-all duration-300 inline-block"
              >
                ابدأ القراءة
              </Link>
            </motion.div>
            ...
            >
              <div className="bg-[#161616] backdrop-blur-xl rounded-2xl p-4 border border-[#262626]">
                <div className="flex flex-col space-y-1">
                  <NavLink to="/" end onClick={() => setIsOpen(false)} className={mobileNavLinkClasses}>
                    الرئيسية
                  </NavLink>
                  <NavLink to="/blog" onClick={() => setIsOpen(false)} className={mobileNavLinkClasses}>
                    المدونة
                  </NavLink>
                  <NavLink to="/about" onClick={() => setIsOpen(false)} className={mobileNavLinkClasses}>
                    من نحن
                  </NavLink>
                  <Link
                    to="/blog"
